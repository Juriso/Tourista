...
const Place3 = ({ route }) => {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={require('./assets/images/La.jpg')} style={styles.image}>
        <View style={styles.overlay}>
          <Text style={styles.title}>{placeName}</Text>
          <Text style={styles.description}>
            The La Mesa Ecopark is a public park located in Greater Lagro, Quezon City, Metro Manila, the Philippines. It is in the La Mesa Watershed
          </Text>
