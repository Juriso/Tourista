...
const Place5 = ({ route }) => {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={require('./assets/images/Real.jpg')} style={styles.image}>
        <View style={styles.overlay}>
          <Text style={styles.title}>{placeName}</Text>
          <Text style={styles.description}>
            Colonial-style, 20th-century nunnery with modernist interiors, where people leave eggs as offerings.
          </Text>
